...
class SalleControllerTest {
    ...
    private String jsonRequest() {
        return """
                ...
                """.formatted(CENTRE_ID, SESSION_ID, FORMATION_ID, PHASE_ID);
    }

    private Salle uneSalle() {
        return new Salle(UUID.randomUUID(), "SALLE ING 1", CENTRE_ID, SESSION_ID, FORMATION_ID, PHASE_ID);
    }
    ...
    void creerSalle_donneesValides_retourne201() throws Exception {
        when(creerSalleUseCase.creerSalle(any(), any(), any(), any(), any())).thenReturn(uneSalle());
    ...
    void creerSalle_centreInexistant_retourne404() throws Exception {
        when(creerSalleUseCase.creerSalle(any(), any(), any(), any(), any()))
    ...
    void reaffecterFormation_retourne200() throws Exception {
        ...
        Salle salle = new Salle(UUID.randomUUID(), "SALLE ING 1", CENTRE_ID, SESSION_ID, nouvelleFormationId, PHASE_ID);
