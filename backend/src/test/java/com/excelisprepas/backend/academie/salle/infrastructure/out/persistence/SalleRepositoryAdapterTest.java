...
@Import({SalleRepositoryAdapter.class, SallePersistenceMapper.class})
...
class SalleRepositoryAdapterTest extends AbstractIntegrationTest {
    ...
    void saveEtFindByIdRetrouveLaSalle() {
        // Given
        Salle salle = new Salle(UUID.randomUUID(), "SALLE ING 1", UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID());
        ...
        assertThat(retrouve.get().getPhaseId()).isEqualTo(salle.getPhaseId());
    }
    ...
    void existsByCentreIdDetecteUneReference() {
        ...
        Salle salle = new Salle(UUID.randomUUID(), "SALLE ING 1", centreId, UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID());
        adapter.save(salle);
    ...
    void existsByFormationIdDetecteUneReference() {
        ...
        Salle salle = new Salle(UUID.randomUUID(), "SALLE ING 1", UUID.randomUUID(), UUID.randomUUID(), formationId, UUID.randomUUID());
        adapter.save(salle);
    ...
    void findAllRetourneToutesLesSalles() {
        adapter.save(new Salle(UUID.randomUUID(), "Salle B", UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID()));
    ...
    void deleteByIdSupprimeLaSalle() {
        Salle salle = new Salle(UUID.randomUUID(), "À supprimer", UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID());
        adapter.save(salle);
    ...
    void findByCentreIdFiltreCorrectement() {
        // Given
        UUID centreId = UUID.randomUUID();
        adapter.save(new Salle(UUID.randomUUID(), "Salle 1", centreId, UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID()));
        adapter.save(new Salle(UUID.randomUUID(), "Salle 2", UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID()));
    ...
    void findBySessionIdFiltreCorrectement() {
        ...
        adapter.save(new Salle(UUID.randomUUID(), "Salle 1", UUID.randomUUID(), sessionId, UUID.randomUUID(), UUID.randomUUID()));
        adapter.save(new Salle(UUID.randomUUID(), "Salle 2", UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID()));
    ...
    void findByCentreIdAndSessionIdCombineLesFiltres() {
        ...
        UUID centreId = UUID.randomUUID();
        UUID sessionId = UUID.randomUUID();
        adapter.save(new Salle(UUID.randomUUID(), "Salle 1", centreId, sessionId, UUID.randomUUID(), UUID.randomUUID()));
        adapter.save(new Salle(UUID.randomUUID(), "Salle 2", centreId, UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID())); // autre session
