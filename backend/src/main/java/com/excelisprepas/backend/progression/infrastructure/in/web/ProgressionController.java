...
public class ProgressionController {
    ...
    private static ProgressionResponse versReponse(Progression progression) {
        return new ProgressionResponse(
                progression.getId(), progression.getFormationId(), progression.getSessionId(), progression.getMatiereId(),
    ...
    @Operation(summary = "Créer une progression",
            description = "Enregistre le contenu dispensé pour un cours d'une formation, une session académique et une matière données.")
    @ApiResponses({
    ...
    public ResponseEntity<ProgressionResponse> creerProgression(@Valid @RequestBody CreerProgressionRequest request) {
        Progression progression = creerProgressionUseCase.creerProgression(
                request.formationId(), request.sessionId(), request.matiereId(), request.semaine(), request.numeroCours(),
