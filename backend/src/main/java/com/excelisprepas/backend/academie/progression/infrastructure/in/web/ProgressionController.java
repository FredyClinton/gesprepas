...
import com.excelisprepas.backend.academie.progression.infrastructure.in.web.dto.CreerProgressionRequest;
import com.excelisprepas.backend.academie.progression.infrastructure.in.web.dto.MettreAJourContenuRequest;
import com.excelisprepas.backend.academie.progression.infrastructure.in.web.dto.ProgressionResponse;
...
@Tag(name = "Progressions", description = "Suivi du contenu pédagogique dispensé par cours, semaine, session et matière")
@RestController
...
public class ProgressionController {
    ...
    private static ProgressionResponse versReponse(Progression progression) {
        return new ProgressionResponse(
                progression.getId(), progression.getFormationId(), progression.getSessionId(), progression.getPhaseId(), progression.getMatiereId(),
    ...
    @Operation(summary = "Créer une progression",
            description = "Enregistre le contenu dispensé pour un cours d'une formation, une session académique, une phase et une matière données.")
    @ApiResponses({
