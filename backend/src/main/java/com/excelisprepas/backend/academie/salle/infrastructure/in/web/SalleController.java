...
import com.excelisprepas.backend.academie.salle.infrastructure.in.web.dto.CreerSalleRequest;
import com.excelisprepas.backend.academie.salle.infrastructure.in.web.dto.ReaffecterFormationRequest;
import com.excelisprepas.backend.academie.salle.infrastructure.in.web.dto.RenommerSalleRequest;
import com.excelisprepas.backend.academie.salle.infrastructure.in.web.dto.SalleResponse;
...
public class SalleController {
    ...
    private static SalleResponse versReponse(Salle salle) {
        return new SalleResponse(salle.getId(), salle.getNom(), salle.getCentreId(),
                salle.getSessionId(), salle.getFormationId(), salle.getPhaseId());
    }

    @Operation(summary = "Créer une salle", description = "Crée une nouvelle salle rattachée à un centre, une session académique, une formation et une phase.")
    @ApiResponses({
