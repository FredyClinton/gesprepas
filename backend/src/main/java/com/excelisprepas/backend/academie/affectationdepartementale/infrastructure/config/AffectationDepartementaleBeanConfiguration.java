package com.excelisprepas.backend.academie.affectationdepartementale.infrastructure.config;
...
import com.excelisprepas.backend.academie.affectationdepartementale.domain.service.AffectationDepartementaleService;
