...
function semaineCouranteDepuis(dateDebut: string, dateFin: string): number {
    const debut = new Date(dateDebut);
    const fin = new Date(dateFin);
    const maintenant = new Date();
    const bornee = maintenant < debut ? debut : maintenant > fin ? fin : maintenant;
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-6">
            ...
            <Card className="overflow-hidden">
                <div className="border-brand-gray/20 border-b p-4">
                            ...
                            {!chargementInitial &&
                                ...
                                (!creneauxEnAttente || creneauxEnAttente.length === 0) && (
                                    <tr>
                                        <td
                                            colSpan={5}
                                            className="text-brand-gray p-4 text-center"
                                        >
